    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('staff', '工作室员工'), ('customer', '客户')], default='customer', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.CharField(choices=[('login', '登录'), ('login_failed', '登录失败'), ('logout', '退出'), ('password_changed', '修改密码')], max_length=32)),
