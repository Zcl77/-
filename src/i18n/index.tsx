...
const en: Record<string, string> = {
  安全结账确认: 'Secure checkout confirmation',
  确认订单与收货信息: 'Confirm order and shipping details',
  '确认后订单才会进入待支付状态。本页面不会连接任何真实支付渠道。':
    'The order enters pending payment only after confirmation. This page does not connect to any real payment provider.',
  返回报价与订单: 'Back to quotes and orders',
  订单金额明细: 'Order amount details',
  商品或服务小计: 'Product or service subtotal',
  运费: 'Shipping',
  税费: 'Tax',
  折扣: 'Discount',
  最终应付总额: 'Final amount due',
  联系与收货信息: 'Contact and shipping details',
  收件信息: 'Recipient details',
  收件人姓名: 'Recipient name',
  联系电话: 'Phone number',
  国家或地区代码: 'Country or region code',
  '使用两个字母，例如 CN 或 US': 'Use two letters, for example CN or US',
  '州/省': 'State / Province',
  城市: 'City',
  详细地址: 'Address',
  邮编: 'Postal code',
  '我已核对订单金额、币种以及联系与收货信息。':
    'I have reviewed the order amount, currency, contact details, and shipping information.',
  结账已确认: 'Checkout confirmed',
  正在确认结账: 'Confirming checkout',
  确认订单并进入待支付: 'Confirm order and continue to pending payment',
  结账状态: 'Checkout status',
  结账未完成: 'Checkout incomplete',
  '结账信息已确认。': 'Checkout details have been confirmed.',
  '结账信息已经确认，无需重复提交。': 'Checkout details are already confirmed.',
  '结账确认失败，请稍后重试。': 'Checkout could not be confirmed. Please try again.',
  进入结账确认: 'Continue to checkout confirmation',
  结账页面无法打开: 'Checkout could not be opened',
  正在读取结账信息: 'Loading checkout details',
  '订单不存在或当前账号无权查看。': 'The order does not exist or this account cannot access it.',
  正在核对订单权限与金额: 'Checking order access and amounts.',
  '正在核对订单权限与金额。': 'Checking order access and amounts.',
  '只有已接受报价的订单可以确认结账。': 'Only an accepted quote can proceed to checkout.',
  '订单当前不处于待确认结账状态。': 'This order is not awaiting checkout confirmation.',
  '国家或地区必须使用两个字母的 ISO 3166-1 代码。': 'Use a two-letter ISO 3166-1 country or region code.',
  知行造境: 'Zhixing Studio',
  ...
  询价购物车: 'Inquiry cart',
  独立站询价: 'Independent shop inquiry',
  购物车: 'Cart',
  购物车还是空的: 'Your cart is empty',
  '把感兴趣的作品加入购物车，再一次提交询价。': 'Add works you like, then submit one inquiry.',
  移除: 'Remove',
  清空: 'Clear',
  前往提交询价: 'Continue to inquiry',
  加入购物车: 'Add to cart',
  '这是询价清单，不是即时付款订单。工作室会根据规格、数量、运输和制作要求确认最终报价。':
    'This is an inquiry list, not an instant payment order. The studio will confirm the final quote based on specifications, quantity, shipping, and production requirements.',
  关闭: 'Close',
...
const errorCodeKeys: Record<string, string> = {
  checkout_not_available: '只有已接受报价的订单可以确认结账。',
  invalid_checkout_state: '订单当前不处于待确认结账状态。',
  invalid_country_code: '国家或地区必须使用两个字母的 ISO 3166-1 代码。',
